...
const RiskSentimentInput: React.FC<RiskSentimentInputProps> = ({
  ...
  return (
    <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300 border border-orange-200 bg-gradient-to-br from-white to-orange-50">
      <CardHeader className="bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-t-lg">
        <CardTitle className="flex items-center gap-3 text-lg font-semibold">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger>
                <Info size={16} className="text-orange-200 hover:text-white transition-colors" />
              </TooltipTrigger>
      ...
      <CardContent className="p-6">
        <div className="space-y-4">
          <div>
            <Label htmlFor="credit-spread" className="text-base font-medium text-gray-700 mb-2 block">Credit Spread 1M Change (%)</Label>
            <Input
              id="credit-spread"
              type="number"
              ...
              step={0.01}
              className="text-base border-orange-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-200"
            />
          ...
          <div>
            <Label htmlFor="vix" className="text-base font-medium text-gray-700 mb-2 block">VIX Level</Label>
            <Input
              id="vix"
              type="number"
              value={vix}
