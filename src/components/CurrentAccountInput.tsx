...
const CurrentAccountInput: React.FC<CurrentAccountInputProps> = ({
  ...
  return (
    <Card className="shadow-md hover:shadow-lg transition-shadow duration-300 border border-cyan-200 bg-gradient-to-br from-white to-cyan-50">
      <CardHeader className="bg-gradient-to-r from-cyan-600 to-blue-600 text-white rounded-t-lg">
        <CardTitle className="flex items-center gap-3 text-lg font-semibold">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger>
                <Info size={16} className="text-cyan-200 hover:text-white transition-colors duration-200" />
              </TooltipTrigger>
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              ...
              step={0.1}
              className="text-base border-cyan-300 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-200 transition-all duration-200"
            />
          ...
          <div>
            ...
            <div className="flex gap-2 mt-1">
              <Input
                ...
                className="border-cyan-300 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-200 transition-all duration-200"
              />
              <Button onClick={addValue} size="sm" className="bg-cyan-600 hover:bg-cyan-700 transition-colors duration-200">Add</Button>
            </div>
            ...
            <div className="flex flex-wrap gap-1 mt-2">
              {ca_5y_values.map((value, index) => (
                <Badge 
                  key={index} 
                  variant="secondary" 
                  className="cursor-pointer bg-cyan-100 text-cyan-800 hover:bg-red-200 transition-colors duration-200"
            ...
            {stats && (
              <div className="mt-2 p-3 bg-gradient-to-r from-cyan-50 to-blue-50 rounded-lg border-l-4 border-cyan-400 shadow-sm">
