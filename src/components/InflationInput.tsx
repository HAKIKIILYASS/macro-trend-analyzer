...
const InflationInput: React.FC<InflationInputProps> = ({
  ...
  return (
    <Card className="shadow-md hover:shadow-lg transition-shadow duration-300 border border-emerald-200 bg-gradient-to-br from-white to-emerald-50">
      <CardHeader className="bg-gradient-to-r from-emerald-600 to-green-600 text-white rounded-t-lg">
        <CardTitle className="flex items-center gap-3 text-lg font-semibold">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger>
                <Info size={16} className="text-emerald-200 hover:text-white transition-colors duration-200" />
              </TooltipTrigger>
        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              ...
              step={0.1}
              className="text-base border-emerald-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all duration-200"
            />
          </div>
          ...
          <div>
            ...
            <Input
              ...
              className="text-base border-emerald-300 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 transition-all duration-200"
            />
            <div className="bg-gradient-to-r from-emerald-50 to-green-50 p-3 rounded-lg mt-3 border-l-4 border-emerald-400 shadow-sm">
